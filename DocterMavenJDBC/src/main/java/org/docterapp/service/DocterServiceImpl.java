...
public class DocterServiceImpl implements IDocterService {
    ...
    private IDocterRepository iDocterRepository=new DocterRepositoryImpl();
    ...
    @Override
    public List<Doctor> getBySpecialityAndNameContains(String speciality, String docterName)throws DocterNotFoundException {
